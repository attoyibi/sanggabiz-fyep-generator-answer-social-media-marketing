  ...
  options: [
    {
      ...
      variants: [
        {
          id: "lo1a",
          headline: "Judul disorot blok warna, label pilar di atasnya",
          fields: { pola: "sorot" },
          points: [
            "Judul diberi blok warna di belakang tiap baris, pola yang paling mudah dikenali di beranda.",
            "Label pilar konten di atas judul memberi tahu isi kontennya sebelum judul dibaca.",
            "Judul ditambatkan ke bagian bawah-tengah, bukan menempel di puncak kanvas.",
            "Nama akun dan penanda halaman di kaki desain membuatnya terbaca sebagai unggahan, bukan salindia.",
          ],
        },
        {
          id: "lo1b",
          headline: "Blok warna di bawah sebagai panggung keterangan",
          fields: { pola: "blok" },
          points: [
            "Kanvas dibagi dua: judul di bidang atas, keterangan di dalam blok warna bawah.",
            "Batas warna yang tegas memisahkan pesan utama dari penjelasannya.",
            "Ukuran judul menyesuaikan panjang naskah supaya tidak pernah menabrak blok.",
            "Cocok ketika keterangan pendukungnya memang perlu dibaca, bukan sekadar pelengkap.",
          ],
        },
        {
          id: "lo1c",
          headline: "Perbandingan dua kotak: yang keliru dan yang tepat",
          fields: { pola: "banding" },
          points: [
            "Dua kotak bertumpuk membandingkan kebiasaan keliru dengan yang lebih tepat.",
            "Warna kedua kotak dibedakan sehingga batasnya terbaca sekali lihat.",
            "Cocok untuk konten yang membetulkan anggapan keliru, seperti rancangan ini.",
            "Judul dijaga maksimal dua baris agar kedua kotak tetap kebagian ruang.",
          ],
        },
      ],
    },
    {
      ...
      variants: [
        {
          id: "lo2a",
          headline: "Semua rata tengah dengan ukuran huruf seragam",
          fields: { pola: "rata" },
          points: [
            "Rata tengah membuat desain terlihat rapi dan seimbang.",
            "Semua teks memakai ukuran yang sama, jadi tidak ada yang dibaca lebih dulu.",
            "Audiens harus membaca seluruhnya untuk tahu pesan utamanya.",
            "Tanpa hierarki, konten seperti ini mudah terlewat saat orang menggeser cepat.",
          ],
        },
      ],
    },
    {
      ...
      variants: [
        {
          id: "lo3a",
          headline: "Teks menempel ke tepi kanvas",
          fields: { pola: "tepi" },
          points: [
            "Menempel ke tepi memberi ruang isi paling luas.",
            "Bagian tepi kanvas justru yang tertutup antarmuka platform.",
            "Judul di puncak layar tertutup nama akun dan tombol pada tampilan Reels.",
            "Ajakan di dasar layar tertimpa tombol suka dan komentar.",
          ],
        },
        {
          id: "lo3b",
          headline: "Semua teks ditumpuk di satu titik tengah",
          fields: { pola: "tumpuk" },
          points: [
            "Menumpuk semua teks di tengah membuat perhatian terpusat pada satu area.",
            "Baris-barisnya saling bertindihan sehingga tidak ada yang terbaca utuh.",
            "Warna teks yang mendekati warna latar memperparah keterbacaannya.",
            "Desain seperti ini biasanya lahir karena naskahnya tidak dipangkas lebih dulu.",
          ],
        },
      ],
    },
  ...
  options: [
    {
      ...
      variants: [
        ...
        },
        {
          ...
          fields: {
            judul: "{{judulKonten}}",
            pendukung: "Bagian dari seri {{pilarKonten}} yang tayang tiap minggu.",
            cta: "Selengkapnya di {{platformKonten}}",
          },
          points: [
            "Nama pilar disebut supaya audiens mengenali jenis kontennya dan tahu seri ini berlanjut.",
